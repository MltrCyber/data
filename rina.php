...
/**
 * HARY-IT | File Manager V2.5.3
 * @author HARY-IT
 * @email haryonokudadiri71@gmail.com
 * @github https://github.com/MltrCyber
 * @link https://instagram.com/haryonokudadiri
 */
...
//Application Title
define('APP_TITLE', 'HARY-IT File Manager');
...
// Generate secure password hash - https://instagram.com/haryonokudadiri/docs/pwd.html
$auth_users = array(
    'hary' => '$2y$10$RiC0NcsCiU58ku1fSuwCGeLSrF.THNSbC9RV2JaOetX5nI6ftcxLK', //admin@123
    'user' => '$2y$10$RiC0NcsCiU58ku1fSuwCGeLSrF.THNSbC9RV2JaOetX5nI6ftcxLK' //12345
);
...
$favicon_path = 'https://haryonokudadiri.com/favicon.png';
...
// sample config - https://instagram.com/haryonokudadiri/config-sample.txt
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://instagram.com/haryonokudadiri/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">HARY-IT</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://instagram.com/haryonokudadiri" target="_blank" class="app-v-title"> HARY-IT File Manager <?php echo VERSION; ?></a></h3></p>
                        <p>Author: Haryono Kudadiri</p>
                        <p>Mail Us: <a href="mailto:haryonokudadiri71@gmail.com">haryonokudadiri71[at]gmail.com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://instagram.com/haryonokudadiri" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://instagram.com/haryonokudadiri" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://instagram.com/haryonokudadiri" target="_blank" class="float-right text-muted">HARY-IT File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://instagram.com/haryonokudadiri" target="_blank" class="float-right text-muted">HARY-IT File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'HARY-IT File Manager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with HARY-IT File Manager">
    <meta name="author" content="HARY-IT">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'HARY-IT File Manager';      $tr['en']['AppTitle']           = 'File Manager';
